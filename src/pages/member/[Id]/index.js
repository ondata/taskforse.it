          ...
          <Container maxWidth='sm'>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <List>
                  <TextListItem
                    keyText='Twitter'
                    valueText={!!member.Twitter && <a target='_blank' href={member.Twitter} rel='noopener noreferrer'><FontAwesomeIcon icon={faTwitter} /></a>}
                  />
                  <TextListItem
                    keyText='Linkedin'
                    valueText={!!member.Linkedin && <a target='_blank' href={member.Linkedin} rel='noopener noreferrer'><FontAwesomeIcon icon={faLinkedin} /></a>}
                  />
                  <TextListItem
                    keyText='Facebook'
                    valueText={!!member.Facebook && <a target='_blank' href={member.Facebook} rel='noopener noreferrer'><FontAwesomeIcon icon={faFacebook} /></a>}
                  />
                  <TextListItem
                    keyText='Instagram'
                    valueText={!!member.Instagram && <a target='_blank' href={member.Instagram} rel='noopener noreferrer'><FontAwesomeIcon icon={faInstagram} /></a>}
                  />
                  <TextListItem
                    keyText='Google Scholar'
                    valueText={!!member['Google Scholar'] && <a target='_blank' href={member['Google Scholar']} rel='noopener noreferrer'><FontAwesomeIcon icon={faGoogle} /></a>}
                  />
                  <TextListItem
                    keyText='Wikipedia'
                    valueText={!!member.Wikipedia && <a target='_blank' href={member.Wikipedia} rel='noopener noreferrer'><FontAwesomeIcon icon={faWikipediaW} /></a>}
                  />
                </List>
              </Grid>
            </Grid>
            ...
            <List>
              ...
              <TextListItem
                ...
                valueText={!!member['E-mail istituzionale'] && <a target='_blank' href={`mailto:${member['E-mail istituzionale']}`} rel='noopener noreferrer'>{member['E-mail istituzionale']}</a>}
              />
              ...
              <TextListItem
                ...
                valueText={!!member['Curriculum Vitae'] && <a target='_blank' href={member['Curriculum Vitae']} rel='noopener noreferrer'><PictureAsPdf /></a>}
              />
